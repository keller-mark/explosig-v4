...
export default function solveQP(DmatOrig, dvecOrig, AmatOrig, bvecOrig = [], meq = 0, factorized = [0, 0]) {

    let Dmat = cloneDeep(DmatOrig);
    let dvec = cloneDeep(dvecOrig);
    let Amat = cloneDeep(AmatOrig);
    let bvec = cloneDeep(bvecOrig);
